...
def getargs(): 
    ...
    parser.add_argument("--pandas", dest="dftype", action="store_const", const="pandas", default="pandas")
    parser.add_argument("--polars", dest="dftype", action="store_const", const="polars", default="pandas")
    parser.add_argument("--dask", dest="dftype", action="store_const", const="dask", default="pandas")
    parser.add_argument("--duckdb", dest="dftype", action="store_const", const="duckdb", default="pandas")
